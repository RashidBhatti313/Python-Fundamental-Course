...
print("The Symmetric Difference phonebook1 and Phonebook3:", Phonebook1 ^ Phonebook1)
print("The Symmetric Difference phonebook3 and Phonebook1:", Phonebook3 ^ Phonebook1)
